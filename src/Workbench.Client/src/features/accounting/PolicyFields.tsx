...
export function PolicyFields({ value, catalog, change }: { value: Policies; catalog: Catalog; change(value: Policies): void }) {
  ...
  return <div className="accounting-policy-groups">
    ...
    <fieldset className="accounting-policy-group"><legend>Accounting dates</legend><p id="accounting-start-help" className="accounting-help">Complete history uses your complete business history, starting with the first transaction. Opening balances use verified balances on your planned start date. Saving this choice does not import history or create balances.</p><div className="accounting-grid">
