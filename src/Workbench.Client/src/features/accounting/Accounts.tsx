...
export function Accounts({ catalog, changed, fail, canManage, onDirtyChange }: { catalog: Catalog; changed(): Promise<void>; fail(error: unknown): void; canManage: boolean; onDirtyChange(dirty: boolean, uncertain: boolean): void }) {
  ...
  return <section aria-labelledby="accounts-heading"><h2 id="accounts-heading" tabIndex={-1}>Accounts</h2><p>General accounts describe financial purpose. Creating accounts does not create balances or accounting entries.</p>
