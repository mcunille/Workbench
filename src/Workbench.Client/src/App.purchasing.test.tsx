...
it('opens purchase orders and replaces a new draft URL after its receipt without losing current-read recovery', async () => {
  ...
  server.use(http.get('*/api/beta/system', () => HttpResponse.json({ name: 'Workbench', version: '1', apiRevision: 'beta-2' })),
    ...
    http.get('*/api/beta/purchase-order-drafts', () => HttpResponse.json({ items: [], nextCursor: null })),
