...
{
    private const string SchemaVersion = "20260911184933_AddAcquisitionDocuments";
        ...
        IReadOnlyDictionary<string, string> arguments, CancellationToken cancellationToken)
    {
        ...
        else if (action == "verify")
        {
            ...
            if (manifest.Version != 1 || manifest.SchemaVersion is not (SchemaVersion or "20260910071000_AddSharedAcquisitions" or "20260909034719_AddAcquisitionContext" or "20260908010000_AddItemRestoration" or "20260907225320_AddOnlineRecovery" or "20260907224158_AddItemArchiving" or "20260907194500_AddItemDetailEditing") || manifest.Database != database || manifest.InstallationId != installation ||
