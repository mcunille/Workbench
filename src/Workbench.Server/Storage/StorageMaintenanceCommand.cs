...
public static class StorageMaintenanceCommand
{
        ...
        IReadOnlyDictionary<string, string> arguments, CancellationToken cancellationToken)
    {
        ...
        else if (action == "verify")
        {
            ...
            if (manifest.Version != 1 || manifest.SchemaVersion is not (SchemaVersion or "20260907194500_AddItemDetailEditing") || manifest.Database != database || manifest.InstallationId != installation ||
