...
namespace Workbench.Server.Persistence.Migrations
{
    ...
    [Migration("20260916183834_AddStructuredDraftOrderLines")]
    partial class AddStructuredDraftOrderLines
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Workbench.Server.Purchasing.DraftOrder", b =>
                {
                    ...
                    b.ToTable("DraftOrders", "Purchasing", t =>
                        {
                            t.HasCheckConstraint("CK_DraftOrders_Content", "[ContentSchemaVersion] IN (1,2) AND ISJSON([ContentJson],OBJECT)=1 AND DATALENGTH([ContentJson])<=1048576");
                    ...
                    b.ToTable("DraftOrderRequestReceipts", "Purchasing", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_DraftOrderRequestReceipts_Fingerprint", "[FingerprintVersion] IN (1,2,3)");
