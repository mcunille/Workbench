                        ...
                        (
                            ...
                            (
                                SELECT 1 FROM (VALUES
                                    ...
                                    (N'workbench_web', N'[Administration].[AccountingRoles]', N'SELECT'),
                                    ...
                                    (N'workbench_web', N'[Accounting].[Receipts]', N'SELECT'),
                                    (N'workbench_web', N'[Accounting].[PolicyFreezes]', N'SELECT'),
                                    (N'workbench_web', N'[Accounting].[SourceEvents]', N'SELECT'),
                                    ...
                                    (N'workbench_web', N'[Identity].[UserClaims]', N'SELECT'),
                                    (N'workbench_web', N'[Identity].[UserLogins]', N'SELECT,INSERT,UPDATE,DELETE'),
                                    (N'workbench_web', N'[Identity].[UserRoles]', N'SELECT'),
                                    (N'workbench_web', N'[Identity].[RoleClaims]', N'SELECT'),
                                    ...
                                    (N'workbench_web', N'[Inventory].[ItemPhotos]', N'SELECT,INSERT'),
                                    ...
                                    (N'workbench_web', N'[Purchasing].[PreparePurchaseOrderDocument]', N'EXECUTE'),
                                    (N'workbench_web', N'[Purchasing].[FinishPurchaseOrderDocument]', N'EXECUTE'),
                                    (N'workbench_web', N'[Purchasing].[PurchaseOrderDocuments]', N'SELECT'),
                                    (N'workbench_web', N'[Purchasing].[PurchaseOrderDocumentOperations]', N'SELECT'),
                                    (N'workbench_web', N'[Inventory].[PrepareAcquisitionDocument]', N'EXECUTE'),
                                    (N'workbench_web', N'[Inventory].[FinishAcquisitionDocument]', N'EXECUTE'),
                                    (N'workbench_web', N'[Inventory].[AcquisitionDocuments]', N'SELECT'),
                                    (N'workbench_web', N'[Inventory].[AcquisitionDocumentOperations]', N'SELECT'),
                                    (N'workbench_web', N'[Purchasing].[CreateDraftOrder]', N'EXECUTE'),
                                    (N'workbench_web', N'[Purchasing].[UpdateDraftOrder]', N'EXECUTE'),
                                    ...
                                    (N'workbench_web', N'[Purchasing].[SavePurchaseOrder]', N'EXECUTE'),
                                    (N'workbench_web', N'[Purchasing].[PurchaseOrderRevisions]', N'SELECT'),
                                    (N'workbench_web', N'[Purchasing].[PurchaseOrderReceipts]', N'SELECT'),
                                    (N'workbench_web', N'[Purchasing].[SaveSupplier]', N'EXECUTE'),
                                    (N'workbench_web', N'[Purchasing].[Suppliers]', N'SELECT'),
                                    (N'workbench_web', N'[Purchasing].[SupplierRequestReceipts]', N'SELECT'),
                                    (N'workbench_web', N'[Purchasing].[PurchaseOrderCounters]', N'SELECT'),
                                    ...
                                    (N'workbench_web', N'[Storage].[RecoveryFiles]', N'SELECT'),
