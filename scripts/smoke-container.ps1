...
"@
    ...
    $attackerHeaders = @{ 'X-Workbench-Api-Revision' = 'beta-3'; 'X-Forwarded-For' = '192.0.2.10'; 'X-Forwarded-Proto' = 'https' }
    ...
    $forwardedHeaders = @{ 'X-Workbench-Api-Revision' = 'beta-3'; 'X-Forwarded-For' = '192.0.2.20'; 'X-Forwarded-Proto' = 'https' }
