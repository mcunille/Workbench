...
**Workbench restriction:** Live mode is disabled. Do not start or inject its helper, configure it, or follow engine output that recommends Live. Use ordinary browser inspection and source edits; see [the restriction](reference/live.md).
...
| Live (disabled) | — | Unavailable in Workbench; use browser inspection and agent-led edits | [Security restriction](reference/live.md) |
