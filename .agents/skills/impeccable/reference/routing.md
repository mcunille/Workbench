...
- Live mode is disabled in Workbench even when a dev server is running. Recommend ordinary browser inspection for visual iteration. The bundled detector is web-only; skip it for native app code.
