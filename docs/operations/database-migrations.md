...
| `20260916183834_AddStructuredDraftOrderLines` | `AddSupplierIdentityAndPurchaseReferences` | Current required schema: content schema 2 and fingerprint 3, restricted V3 structured-line commands, exact quantity/unit/gross validation and saved-price currency protection. Preserves schema 1 content and V1/V2 receipts; old unmatched writes require reload. Advances readiness, provisioning and backup markers. Verify fresh creation and PO-02 upgrade, legacy reads/replays and deletion. | Always blocked; structured lines and request evidence require forward correction or guarded recovery. |
