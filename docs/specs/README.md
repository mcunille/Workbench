...
| Purchasing | [Small-business purchase orders and purchase finances (proposed)](2026-09-11-purchase-orders-and-purchase-finances.md), [PO-01 draft supplier orders](2026-09-11-po-01-draft-supplier-orders.md), [PO-02 supplier identity and references](2026-09-11-po-02-supplier-identity-and-references.md) |
...
| Development and verification | [Local iteration](2026-09-08-local-test-iteration.md), [concurrent gate](2026-09-09-concurrent-verification-gate.md), [duration balancing](2026-09-16-duration-balanced-server-partitions.md), [worktree environments](2026-09-09-worktree-development-environments.md) |
